...
![Viewing the batch in the node tree](../assets/img/vol-1/2-1/003.png)
...
![Looking at the batch viewer from the node tree](../assets/img/vol-1/2-1/005.png)

!!! abstract "Step 2"
    Click the **+** button next to the batch in the node tree to expand it.

![Expanding the batch in the node tree](../assets/img/vol-1/2-1/006.png)
...
![The batch folder in the node tree](../assets/img/vol-1/2-1/007.png)

![Observing the Batch Process under the batch in the node tree](../assets/img/vol-1/2-1/009.png)
...
![Cloning the production batch to test](../assets/img/vol-1/2-1/013.png)
...
![Viewing the cloned batch in the node tree](../assets/img/vol-1/2-1/020.png)
...
![Selecting the test batch](../assets/img/vol-1/2-1/028.png)

After you select the batch, it will appear in the batch viewer below.

![Observing the test batch in the batch viewer](../assets/img/vol-1/2-1/029.png)
...
![Adding the "Auto Deskew" command](../assets/img/vol-1/2-1/030.png)
...
![Testing the "Auto Deskew" command](../assets/img/vol-1/2-1/031.png)
...
![Fit the current page to the width of the display window](../assets/img/vol-1/2-1/032.png)
...
![Result image vs. original image](../assets/img/vol-1/2-1/33-34.gif)

Check it out on page two.

![Result image vs. original image](../assets/img/vol-1/2-1/35-36.gif)

!!! abstract "Step 5"
    Click **Save**.

![Saving the profile](../assets/img/vol-1/2-1/037.png)
...
![Adding the "Auto Border Crop" command](../assets/img/vol-1/2-1/038.png)
...
![Comparing the cropped image with the original](../assets/img/vol-1/2-1/40-41.gif)
...
![Saving the profile](../assets/img/vol-1/2-1/042.png)
    
!!! abstract "Step 9"
    Select **Page 1** in our batch. Click on **Add**, and then select **Border Cleanup > Border Fill.**

![Adding the "Border Fill" command](../assets/img/vol-1/2-1/044.png)
...
![Changing the "Border Region Size" property](../assets/img/vol-1/2-1/048.png)
...
![Changing the "Method" property](../assets/img/vol-1/2-1/052.png)
    
!!! abstract "Step 12"
    Click **Execute** and check out the results.

![Checking the results](../assets/img/vol-1/2-1/53-54.gif)
...
![Adding "Patch Code Detection" command and saving](../assets/img/vol-1/2-1/551-561.gif)
...
![Navigating to the working process](../assets/img/vol-1/2-1/057.png)

!!! abstract "Step 2"
    Click **Add Step...**.

![Adding a new step to the process](../assets/img/vol-1/2-1/058.png)
...
![Configuring the step for image processing](../assets/img/vol-1/2-1/060.png)

!!! abstract "Step 4"
    **Save** and **Publish** our process.
    
![Save and Publish the process](../assets/img/vol-1/2-1/61-62.gif)
...
![Navigating to the production batch](../assets/img/vol-1/2-1/064.png)
...
![Updating the batch to reflect the changes made to the process](../assets/img/vol-1/2-1/066.png)

The **Update Process** window will appear.

![Viewing the Update Process window](../assets/img/vol-1/2-1/067.png)
...
![Selecting the "Image Processing" step](../assets/img/vol-1/2-1/069.png)

We will return to Grooper Design Studio, only now our batch's **Task Status** panel has another step in it.

![Observing the new task that has been added in the production batch](../assets/img/vol-1/2-1/070.png)
...
![Resuming the batch](../assets/img/vol-1/2-1/071.png)
...
![Observing the new step in the node tree](../assets/img/vol-1/2-1/075.png)
...
![Telling the batch to begin processing the "Image Processing" step](../assets/img/vol-1/2-1/77-78.gif)
...
![Grooper Unattended Client](../assets/img/vol-1/2-1/079.png)
...
![Observing the batch after completing Image Processing](../assets/img/vol-1/2-1/081.png)
...
![Adding an Image Review step to the Batch Process](../assets/img/vol-1/2-2/001.png)
...
![Pausing the batch](../assets/img/vol-1/2-2/2-5-9.gif)

![Updating the batch to receive the Image Review step](../assets/img/vol-1/2-2/10-11-12-13.gif)

We should see another step in the **Task Status** panel, just like when we added **Image Processing**.

![Observing the updated batch with the Image Review step added](../assets/img/vol-1/2-2/014.png)

!!! abstract "Step 3"
    **Resume** the batch.

![Resuming the batch](../assets/img/vol-1/2-2/015.png)

!!! abstract "Step 4"
    Click **Process** to start this activity.

![Clicking "Process" on the Image Review step](../assets/img/vol-1/2-2/019.png)
...
![Batch opening in Grooper Attended Client](../assets/img/vol-1/2-2/020.png)
...
![Clicking on the Thumbnail Viewer tab](../assets/img/vol-1/2-2/20-22.gif)
...
![Sorting the images](../assets/img/vol-1/2-2/023.png)

!!! abstract "Step 7"
    Select the **Sort By Intensity** option.

![Sorting by intensity](../assets/img/vol-1/2-2/024.png)
...
![Viewing the sorted images](../assets/img/vol-1/2-2/025.png)
...
![Viewing the blank pages](../assets/img/vol-1/2-2/026.png)
...
![Deleting the blank pages](../assets/img/vol-1/2-2/027.png)

Ta-da! They're all gone.

![Observing the batch with no more blank pages](../assets/img/vol-1/2-2/030.png)
...
![Viewing the batch back in the Batch Viewer tab](../assets/img/vol-1/2-2/032.png)
...
![Reviewing all of the images](../assets/img/vol-1/2-2/35-36.gif)

!!! abstract "Step 11"
    Click the **Complete Task** button to finish this activity and return to Grooper Design Studio.

![Completing Image Review](../assets/img/vol-1/2-2/037.png)
...
<!-- |G|r|o|
:---:|:---:|:---:
![Pixels for a serif "G"](../assets/img/vol-1/2-3/ref/ocr-01.jpg) | ![Pixels for a serif "r"](../assets/img/vol-1/2-3/ref/ocr-02.jpg) | ![Pixels for a serif "o"](../assets/img/vol-1/2-3/ref/ocr-03.jpg) -->
...
![Viewing a pre-built OCR Profile](../assets/img/vol-1/2-3/001.png)
...
![Viewing the IP Profile on the OCR Profile](../assets/img/vol-1/2-3/002.png)

!!! abstract "Step 3"
    Navigate to the location of the IP Profile, which is ***(root)* > Global Resources > IP Profiles > Downloads > OCR Cleanup**.

![Navigating to the configured IP Profile](../assets/img/vol-1/2-3/004.png)
...
![Learning about the IP Profile from its "Description" property](../assets/img/vol-1/2-3/005.png)
...
![Configuring the OCR step in the Batch Process](../assets/img/vol-1/2-3/018.png)
...
![Pausing the batch](../assets/img/vol-1/2-3/19-20-24.gif)

![Updating the batch](../assets/img/vol-1/2-3/25-26-27.gif)

!!! abstract "Step 3"
    1. **Resume** the batch.
    2. Click **Process** to kick off the OCR activity.

![Resuming and processing the new OCR step](../assets/img/vol-1/2-3/29-33.gif)

The **Grooper Unattended Client** should kick off again and start processing against the pages in the batch.

![Unattended Client processing OCR on the batch](../assets/img/vol-1/2-3/034.png)
