...
![Add a new Batch Process step](../assets/img/vol-1/1-2/005.png)
...
![Confirming the batch details](../assets/img/vol-1/1-3/024.png)
...
![Viewing the batch with Scan now complete](../assets/img/vol-1/1-3/034.png)
