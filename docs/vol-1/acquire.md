...
![Adding a new Batch Process](../img/vol-1/1-2/001-002.gif)
...
![Naming the Batch Process](../img/vol-1/1-2/003.png)
...
![Add a new Batch Process step](../img/vol-1/1-2/005.png)

!!! abstract "Step 5"
    This will create a blank step in our Process.

![New Step added to the Process](../img/vol-1/1-2/006.png)
...
![Setting "Activity Type" to "Scan"](../img/vol-1/1-2/007.png)

!!! abstract "Step 7"
    Our validation error should go away now that we've satisfied the requirement.

!["Activity Type" successfully set to "Scan"](../img/vol-1/1-2/008.png)
...
![Saving the Batch Process](../img/vol-1/1-2/009.png)

!!! abstract "Step 9"
    Click **Publish** to make this Batch Process available for production use.

![Publishing the Batch Process to Production](../img/vol-1/1-2/010.png)
...
![Comparing the "Working" process with the "Published" one](../img/vol-1/1-2/016.png)
...
![Adding a new Scanner Profile](../img/vol-1/1-3/001.png)
...
![Naming the Scanner Profile](../img/vol-1/1-3/004.png)
...
![Selecting the scan device](../img/vol-1/1-3/007.png)
...
![Selecting the scan device](../img/vol-1/1-3/008.png)
...
![Selecting the scan device](../img/vol-1/1-3/013.png)
...
![Selecting the scan device](../img/vol-1/1-3/014.png)
...
![Saving the Scanner Profile](../img/vol-1/1-3/015.png)
...
![Navigating to the Batches node](../img/vol-1/1-3/016.png)
...
![Creating a production batch](../img/vol-1/1-3/018.png)
...
![Batch Properties window](../img/vol-1/1-3/019.png)
...
![Naming the batch](../img/vol-1/1-3/020.png)

!!! abstract "Step 4"
    From the **Batch Process** dropdown, select **Invoices Process**.

![Selecting the Batch Process](../img/vol-1/1-3/022.png)

!!! abstract "Step 5"
    We're done here, so click **OK** to return close this window and create our batch.

![Confirming the batch details](../img/vol-1/1-3/024.png)

!!! abstract "Step 6"
    Back in **Grooper Design Studio** we should see our new batch in our list.

![Observing the new batch in Grooper Design Studio](../img/vol-1/1-3/025.png)
...
![Clicking the Process button](../img/vol-1/1-3/026.png)

This will bring up the **Attended Client** window for the **Scan** activity.

![Observing the Attended Client](../img/vol-1/1-3/027.png)
...
![The Scan Profile selection list](../img/vol-1/1-3/028.png)

![Selecting the Scan Profile](../img/vol-1/1-3/029.png)
...
![Scanning in the images](../img/vol-1/1-3/030.png)

As the pages are scanned in, their images will display in the panel on the right.

![Pages being scanned in](../img/vol-1/1-3/031.png)
...
![Completing the Scan task](../img/vol-1/1-3/033.png)
...
![Viewing the batch with Scan now complete](../img/vol-1/1-3/034.png)
